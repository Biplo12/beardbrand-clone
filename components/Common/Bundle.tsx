...
const Bundle: React.FC = (): JSX.Element => {
  return (
    <div className="w-full min-h-[60vh] h-auto flex justify-around items-center bg-charleston-green px-[75px] py-10 flex-wrap mxlg:gap-5 mxsm:p-[10px]">
      <div className="flex flex-col justify-center items-center gap-5">
        <img
          ...
          className="h-[64px]"
        />
        <h1 className="font-pano text-md text-center mxxsm:text-[5vw]">
          BUILD YOUR BUNDLE
        </h1>
